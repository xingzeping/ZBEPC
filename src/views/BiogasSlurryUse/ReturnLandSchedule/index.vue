    ...
    exportExcel() { // 导出Excel
      ...
      request({
        ...
        if (response.status === 200) {
          ...
          const tHeader = ['片区', '分公司','环保站','年月','还田日期','天气','还田类型','还田作物','作物面积/亩','消纳量/方','消纳员','状态','录入人','审核人','录入时间']
      		const filterVal = [ 'pq', 'fgs','name','time1','executeTime1','weather','returnType','crop','acreage','use','operatorName','status','creatorName','auditorName','createTime1']
				  const list = dd
