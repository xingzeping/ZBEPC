  ...
  <div class="app-container">
        ...
        <el-row :gutter="30">
          ...
          <el-col :xs="24" :sm="12" :md="8" :lg="8" :xl="8">
            <el-form-item label="分公司:" class="postInfo-container-item">
              <el-input v-model="searchForm.fgs_name" placeholder="请输入分公司"/>
            </el-form-item>
          </el-col>
          <el-col :xs="24" :sm="12" :md="8" :lg="8" :xl="8">
          ...
          <el-col :xs="24" :sm="12" :md="8" :lg="8" :xl="8">
						<el-form-item label="日期:" class="postInfo-container-item">
							<el-date-picker v-model="searchForm.date" type="date" value-format="yyyy-MM-dd" placeholder="选择日期" style="width: 100% ;" />
						</el-form-item>
					</el-col>
    ...
    <div class="container dataContent">
      <el-table :data="projectData" border show-summary>
        ...
        <el-table-column prop="qutoa" label="本日定额">
        </el-table-column>
        <el-table-column prop="use_total" label="本日实际">
        </el-table-column>
        <el-table-column prop="subtract" label="本日偏差">
        </el-table-column>
				</el-table>
      <el-pagination
    ...
    exportExcel() { // 导出Excel
      ...
      request({
        ...
        if (response.status === 200) {
          ...
          const tHeader = ['片区', '分公司','环保站','本日定额','本日实际','本日偏差']
				  const filterVal = [ 'pq_name', 'fgs_name','name','qutoa','use_total','subtract']
				  const list = dd
				  const titlename = v.title
